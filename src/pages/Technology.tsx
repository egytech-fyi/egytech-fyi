  ...
  const options = {
    ...
    tooltip: {
      formatter: function (this: TooltipFormatterContextObject): string {
        return '<b>' + this.x + '</b>: Mentioned ' + this.y + '% by the participants'
      },
    },
    series: [
      {
        name: 'Percentages',
        data: [
          24.1, 75.9, 63, 24.1, 48.1, 13, 29.6, 7, 4, 16.7, 11.1, 5.6, 5.6, 11.1, 5.6, 5.6, 7.4,
        ],
      },
...
export const Technology = () => {
  return (
    <div>
      ...
      <Divider />
      <div id='technology' style={{ width: '100%', marginBottom: '10px' }}>
        <StepCard>
          <div className='salary-comment-container'>
            <BaseComment>
