        ...
        <div>
            ...
            >
                ...
                <div className="salary-comment-container">
                    <BaseComment>
                        We specifically inquired about the participants' most
                        recent salary increments, particularly in light of
            ...
            >
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            Almost 40% had a salary increase in the last 3
                            months
                        </BaseComment>
                    </div>
            ...
            >
                <div className="salary-comment-container">
                    <BaseComment>
                        We asked the participants if they have been working in
                        the same company for the past year <br />
                    </BaseComment>
                </div>
            </div>
            ...
            <div style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            Around 37% of the participants with more than one
                            year of experience, changed companies this past
                            year! 🤝🏼
                        </BaseComment>
                    </div>
                    <SameCompanyPieChart />
            ...
            <div
                id="salaries-rise-with-currencies"
                style={{ width: "100%", marginBottom: "10px" }}
            >
                <div className="salary-comment-container">
                    <BaseComment>
                        We wanted to know how to tech salaries are moving with
                        currency devaluation, using Egyptian Geeks 2017 report
                        and our reports from previous years. <br />
                    </BaseComment>
                </div>
            </div>
            <div style={{ width: "100%", marginBottom: "20px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            Although tech salaries have risen, they are barely
                            keeping pace with the devaluation of the Egyptian
                            pound. 💵 <br />
                        </BaseComment>
                    </div>
            ...
            >
                <div className="salary-comment-container">
                    <BaseComment>
                        We wanted to know the percentage of the participants who
                        receive their salaries in another currency. <br />
                    </BaseComment>
                </div>
            </div>
            <div style={{ width: "100%", marginBottom: "20px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            The number of participants receiving their salaries
                            in currencies other than EGP is growing. 💵 <br />
                        </BaseComment>
                    </div>
                    <CurrencyPieChart />
                </StepCard>
            ...
            >
                <div className="salary-comment-container">
                    <BaseComment>
                        We asked the participants about their salary
                        satisfaction 😊 <br />
                    </BaseComment>
                </div>
            </div>
            ...
            <div style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            More than 50% thought they should earn more
                        </BaseComment>
                    </div>
            ...
            <div style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            We wanted to see the gender distribution between
                            these answers 👩🏽 👨🏼
                        </BaseComment>
                    </div>
            ...
            <Divider />
            <div
                id="level-satisfaction"
                style={{ width: "100%", marginBottom: "10px" }}
            >
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            More 61% of the participants think they are placed
                            in the level they deserve 🎉
                        </BaseComment>
                    </div>
            ...
            <div style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div id="value" className="salary-comment-container">
                        <BaseComment>
                            The majority of participants find value in their
                            work ❤️
                        </BaseComment>
                    </div>
                    <ValuePieChart />
                ...
                <StepCard>
                    <div id="learning" className="salary-comment-container">
                        <BaseComment>
                            The majority also think they have the opportunity to
                            learn new stuff! 📚
                        </BaseComment>
                    </div>
                    <LearningPieChart />
            ...
            <div style={{ width: "100%", marginBottom: "20px" }}>
                <StepCard>
                    <div
                        id="preferred-work-setting"
                        className="salary-comment-container"
                    >
                        <BaseComment>
                            This year, 71% of the participants expressed a
                            preference for a hybrid work setting. That's a
                            significant surge from 63% back in 2022! 🏢 🏠
                        </BaseComment>
                    </div>
