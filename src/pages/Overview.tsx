        ...
        <div>
            ...
            >
                ...
                <div className="salary-comment-container">
                    <BaseComment>
                        This year, we got 1,729 responses, a 33% jump from last
                        time when we got around 1,300. About 1,650 were valid,
                        and roughly 1,200 were verified, where participants
                        shared their company names or personal info!
                        <br />
                        <br />
                        Here we're exploring the analysis of these answers. If
                        you prefer to compare your salary with others first then
                        <br />
                        <br />
                        <Link to="/dashboard">
                            <Button type="default">
                                Access Our Salary Dashboard 💸
                            </Button>
                        </Link>
                        <br />
                    </BaseComment>
            ...
            <div id="gender" style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            Among the participants, 388 were from females, and
                            1,341 were from males 🎉
                        </BaseComment>
                    </div>
                    <GenderPieChart />
                </StepCard>
            ...
            <div id="title" style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            The majority of participants had an engineering
                            background, with over 50% specializing in Backend,
                            Frontend, or Fullstack development.
                        </BaseComment>
                    </div>
                    <TitlePieChart />
                </StepCard>
            ...
            <div id="degree" style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            Of these participants, 1,358 held a Computer Science
                            related degree, while 371 did not.
                        </BaseComment>
                    </div>
            ...
            <div id="level" style={{ width: "100%", marginBottom: "10px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            For the third year, we haven't had many participants
                            in higher level. <br />
                            Only 10% of the participants were in levels higher
                            than Senior Level.
                        </BaseComment>
                    </div>
                    <LevelPieChart />
            ...
            >
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            In 2022, 14.4% of participants from Egypt worked
                            remotely for overseas companies. This year, that
                            figure has risen to 18.1%.
                        </BaseComment>
                    </div>
                    <WorkSettingPieChart />
                </StepCard>
            ...
            >
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            The majority of the participants are working in
            ...
            <div id="location" style={{ width: "100%", marginBottom: "20px" }}>
                <StepCard>
                    <div className="salary-comment-container">
                        <BaseComment>
                            As expected, 74% of participants working in
                            comapnies located in Cairo!. <br />
                        </BaseComment>
                    </div>
